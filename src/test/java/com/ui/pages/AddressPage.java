...
public class AddressPage extends BrowserUtility{
	...
	public String saveAddress(AddressPOJO addressPOJO)
	{
		...
		clearText(OTHER_INFORMATION_TEXTAREA_LOCATOR);
		...
		selectOptionFromDropDown(STATE_DROPDOWN_LOCATOR, addressPOJO.getState());
		clickOn(SAVE_ADDRESS_BUTTON_LOCATOR);
		String newAddressText = getVisibleText(ADDRESS_HEADING);
