...
public class AddNewAddressTest extends TestBase {
	...
	@Test(description="Verify if the logged in user is able to add the new address", groups= {"regression","sanity","smoke"}, dataProviderClass=com.ui.dataproviders.MultiDataProvider.class, 
