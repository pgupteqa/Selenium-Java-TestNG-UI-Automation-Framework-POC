...
public class EndToEndProductCheckoutTest extends TestBase {
	...
	@Test(description = "User selects the product and proceed to checkout", groups = { "smoke", "sanity",
			"regression" }, dataProviderClass = com.ui.dataproviders.MultiDataProvider.class, dataProvider = "ValidLoginDataProvider", retryAnalyzer = com.ui.listeners.RetryAnalyzer.class)
